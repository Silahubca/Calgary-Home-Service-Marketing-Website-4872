...
const { FiTarget, FiTrendingUp, FiUsers, FiDollarSign, FiCheck, FiArrowRight } = FiIcons;
...
const GoogleAds = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await createLead({
        ...formData,
        source: 'Google Ads Management Page',
        type: 'Google Ads Consultation'
      });
  ...
  const results = [
    { metric: '300%', description: 'Average increase in qualified leads' },
    { metric: '150%', description: 'Improvement in conversion rates' },
  ...
  return (
    <>
      <SEOHead
        title="Google Ads Management Calgary - Expert PPC Services"
        description="Professional Google Ads management for Calgary home service businesses. Increase leads, reduce costs, and maximize ROI with our expert PPC campaigns."
        keywords="Google Ads management Calgary, PPC services Calgary, Google Ads Calgary, pay per click advertising, home service Google Ads"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-xl mb-8 text-gray-100 leading-relaxed">
                  Get immediate visibility and attract qualified customers with expertly managed Google Ads campaigns. Our proven strategies help Calgary home service businesses maximize ROI and dominate search results.
                </p>
              ...
              >
                <img 
                  ...
                  alt="Google Ads dashboard showing campaign performance" 
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-600">
                Real results from Calgary businesses using our Google Ads management
              </p>
            </motion.div>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Comprehensive Google Ads management designed specifically for Calgary home service businesses.
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <img 
                  ...
                  alt="Google Ads campaign optimization" 
                  className="rounded-2xl shadow-2xl" 
                />
              </motion.div>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              >
                ...
                <p className="text-xl text-gray-600">
                  Discover how Google Ads can drive more qualified leads to your Calgary business.
                </p>
              </motion.div>
              ...
              >
                {submitSuccess ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-600">We'll send you a comprehensive Google Ads audit within 24 hours.</p>
                  </div>
                ) : (
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      <textarea
                        name="message"
                        placeholder="Tell us about your Google Ads goals..."
                        rows="4"
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              <p className="text-xl mb-8 max-w-2xl mx-auto">
                Join successful Calgary businesses that trust our Google Ads expertise to drive their growth.
              </p>
